...
const MobileNavLinks: React.FC<IMobileNavLinksProps> = ({
    ...
    return (
        <div className={mobileMenu === true ? "mobile-toggle show" : "mobile-toggle"}>
            <ul>
                <li>
                    <Link to="/members">
                        {t("meetmembers")}
                ...
                {history.location.pathname !== "/settings" && (
                    <React.Fragment>
                        {!isCouple && (
                            <li>
                                <span onClick={() => { history.push({ pathname: "/settings", state: { showCplMdl: true } }); }}>
                                    {t("common:addcoup")}
                                </span>
                            </li>
                        )}
                        {!isBlack && (
                            <li>
                                <span
                                    onClick={() => { history.push({ pathname: "/settings", state: { showBlkMdl: true } }); }}
