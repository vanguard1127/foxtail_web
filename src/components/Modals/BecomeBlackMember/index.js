...
class BecomeBlackMember extends PureComponent {
  render() {
    ...
    return (
      <Modal close={this.props.close} fullWidth className="black" noBorder noHeader>
        <div className="upgrade" style={{ backgroundImage: `url(${BecomeBlackMemberImage})` }}>
          ...
          <div className="upgrade-content">
            ...
            <CreateSubBtn close={close} t={t} ErrorHandler={ErrorHandler} notifyClient={notifyClient} lang={lang} />
          </div>
        </div>
      </Modal>
    );
